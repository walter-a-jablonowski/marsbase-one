    ...
    <div class="col-md-8">
      <div class="card card-mars">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="index.php?page=items&action=create" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Upload an image that represents this item</div>
            </div>
            ...
            <div class="d-grid gap-2">
              <button type="submit" class="btn btn-mars">Create Item</button>
              <a href="index.php?page=items" class="btn btn-outline-secondary">Cancel</a>
            </div>
          </form>
        </div>
      </div>
